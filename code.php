...
if(isset($_POST['register_btn']))
{
    ...
    if($createdUser)
    {
        $_SESSION['status'] = "User Created/Registered Successufully";
...
if(isset($_POST['delete_btn']))
{
    ...
    {
        $_SESSION['status'] = "Contact Deleted Successufully";
...
if(isset($_POST['update-contact']))
{
    ...
    $udpdatequery = $database->getReference($ref_table)->update($updatedata);
    
    if($udpdatequery)
    {
        $_SESSION['status'] = "Contact Updated Successufully";
        header('Location: index.php');
...
if(isset($_POST['save-contact']))
{
    ...
    if($postRef_result)
    {
        $_SESSION['status'] = "Contact Added Successufully";
        var_dump($postData);
        header('Location: index.php');
    }
    else
